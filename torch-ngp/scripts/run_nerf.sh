...
python main_nerf.py data/cvar_lab  --workspace cvar_lab -O --bound 1 --scale 0.8 --dt_gamma 0 --num_rays 1048 --num_steps 256
#python main_nerf.py data/lego  --workspace trial_nerf_lego -O --bound 1 --scale 0.8 --dt_gamma 0
