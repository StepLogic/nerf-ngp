...
class Trainer(object):
    ...
    def train_step(self, data):
        ...
        outputs = self.model.train_render(rays_o, rays_d, staged=False, bg_color=bg_color, perturb=True, force_all_rays=False if self.opt.patch_size == 1 else True, **vars(self.opt))
